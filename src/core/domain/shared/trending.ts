 ...
 * Trending score.
 *
 * Хранится колонкой `post.trend_score`, пересчитывается джобой; здесь —
 * формула, по которой считается и она, и любой разовый пересчёт.
 *
 ...
 * это предикат джобы пересчёта, а не оптимизация на будущее.
 */
